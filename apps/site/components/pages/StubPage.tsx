...
const TITLES: Record<string, { title: string; note: string }> = {
  [ROUTES.results]: {
    ...
    note: 'Здесь будут истории пациентов с динамикой по шкалам. Публикуем только те, на которые получено письменное согласие, поэтому раздел наполняется медленно.',
  },
  [ROUTES.relatives]: {
    title: 'Родственникам',
