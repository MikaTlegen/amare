...
function Facts() {
  return (
    <section aria-label='Коротко о клинике' className='mx-auto grid max-w-content gap-x-8 gap-y-10 px-5 py-20 sm:grid-cols-2 sm:px-8 lg:grid-cols-4 lg:px-20'>
...
function EntryPoints() {
  return (
    <section className='bg-bg px-5 pb-12 sm:px-8 lg:px-20'>
...
function Directions() {
  return (
    <section className='bg-deep px-5 py-20 text-white sm:px-8 lg:px-20'>
      <div className='mx-auto grid max-w-content gap-16 lg:grid-cols-12'>
        <Reveal className='lg:col-span-5'>
          ...
          <h2 className='mt-4 font-display text-3xl font-semibold leading-[1.15] tracking-[-0.045em] sm:text-5xl'>
          ...
          <Link href={ROUTES.directions} className='mt-8 inline-flex items-center gap-2 text-base font-semibold text-white no-underline hover:text-sky'>
            Все направления
        ...
        <div className='lg:col-span-6 lg:col-start-7'>
          {DIRECTIONS.slice(0, 5).map((direction, index) => (
            <Reveal key={direction.id} delay={index * 0.1} className='border-t border-white/20 py-5'>
              <Link href={`${ROUTES.directions}#${direction.id}`} className='group flex items-baseline justify-between gap-6 text-xl text-white no-underline sm:text-2xl'>
  ...
  return (
    <section className='mx-auto grid max-w-content gap-16 px-5 py-24 sm:px-8 lg:grid-cols-12 lg:px-20'>
      <Reveal className='lg:col-span-5'>
        ...
        <h2 className='mt-4 font-display text-3xl font-semibold leading-[1.15] tracking-[-0.045em] text-ink sm:text-5xl'>
        ...
        <Link href={ROUTES.course} className='mt-8 inline-flex items-center gap-2 text-base font-semibold text-ink no-underline hover:text-brand'>
...
function Team() {
  return (
    <section className='bg-tint px-5 py-20 sm:px-8 lg:px-20'>
      <div className='mx-auto max-w-content'>
        <Reveal className='flex flex-col justify-between gap-6 sm:flex-row sm:items-end'>
          ...
          <Link href={ROUTES.team} className='inline-flex items-center gap-2 text-base font-semibold text-ink no-underline hover:text-brand'>
...
function Contact() {
  return (
    <section className='relative isolate overflow-hidden bg-deep px-5 py-24 text-white sm:px-8 lg:px-20'>
      ...
      <div className='mx-auto grid max-w-content gap-12 lg:grid-cols-12 lg:items-end'>
        <Reveal className='lg:col-span-8'>
          ...
          <h2 className='mt-4 max-w-[14em] font-display text-4xl font-semibold leading-[1.12] tracking-[-0.05em] sm:text-6xl'>
          ...
          <div className='mt-8 flex flex-wrap items-center gap-5'>
            ...
            <a href={CLINIC.phones[0].href} className='inline-flex items-center gap-2 text-base font-semibold text-white no-underline hover:text-sky'>
